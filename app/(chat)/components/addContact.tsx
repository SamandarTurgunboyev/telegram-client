        ...
        <div className='h-screen w-full flex z-40 relative'>
            <div className='flex justify-center items-center z-50 w-full'>
                <div className='flex flex-col items-center gap-4'>
                    <FaTelegram className='dark:text-blue-400 text-blue-500' size={120} />
                    <h1 className='text-3xl font-bold font-spaceGrotesk'>Add contacts to start chatting</h1>
                    <Form {...contactForm}>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <Label>Email</Label>
                                        <FormControl>
                                            <Input placeholder="info@sammi.ac" className='h-10 bg-[var(--secondary)]' {...field} disabled={isCreating} />
                                        </FormControl>
                                        <FormMessage className='text-xs text-red-500' />
                                    </FormItem>
                                )}
                            />
                            <Button type="submit" className='bg-blue-500 w-full' size={"lg"} disabled={isCreating}>Submit</Button>
                        </form>
                    </Form>
                </div>
            </div>
